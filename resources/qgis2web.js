...
var map = new ol.Map({
    controls: ol.control.defaults({attribution:false}).extend([
        expandedAttribution,new ol.control.ScaleLine({}),new geolocateControl()
    ]),
...
map.getView().fit([-11806497.201845, 4242935.256194, -11786733.247245, 4261014.651214], map.getSize());
